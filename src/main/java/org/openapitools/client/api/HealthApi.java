...
public class HealthApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Confirmation that the service is healthy and can make embedding vectors </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Service error relating to making an embedding or overall service health </td><td>  -  </td></tr>
     </table>
     */

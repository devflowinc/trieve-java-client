...
public class MatchCondition extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(MatchCondition.class.getName());
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<MatchCondition>() {
                ...
                public MatchCondition read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        MatchCondition ret = new MatchCondition();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for MatchCondition: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public MatchCondition(Long o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MatchCondition(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for MatchCondition with oneOf schemas: Long, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }

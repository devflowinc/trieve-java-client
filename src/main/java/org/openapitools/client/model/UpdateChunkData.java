...
public class UpdateChunkData {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateChunkData updateChunkData = (UpdateChunkData) o;
    return Objects.equals(this.chunkHtml, updateChunkData.chunkHtml) &&
        Objects.equals(this.chunkId, updateChunkData.chunkId) &&
        Objects.equals(this.groupIds, updateChunkData.groupIds) &&
        Objects.equals(this.groupTrackingIds, updateChunkData.groupTrackingIds) &&
        Objects.equals(this.link, updateChunkData.link) &&
        Objects.equals(this.metadata, updateChunkData.metadata) &&
        Objects.equals(this.timeStamp, updateChunkData.timeStamp) &&
        Objects.equals(this.trackingId, updateChunkData.trackingId) &&
        Objects.equals(this.weight, updateChunkData.weight);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chunkHtml, chunkId, groupIds, groupTrackingIds, link, metadata, timeStamp, trackingId, weight);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateChunkData
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateChunkData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateChunkData is not found in the empty JSON string", UpdateChunkData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateChunkData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateChunkData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("chunk_id") != null && !jsonObj.get("chunk_id").isJsonNull()) && !jsonObj.get("chunk_id").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateChunkData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateChunkData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateChunkData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateChunkData.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateChunkData>() {
           @Override
           public void write(JsonWriter out, UpdateChunkData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateChunkData read(JsonReader in) throws IOException {
  ...
  * @return An instance of UpdateChunkData
  * @throws IOException if the JSON string is invalid with respect to UpdateChunkData
  */
  public static UpdateChunkData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateChunkData.class);
  }
